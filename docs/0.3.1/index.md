...
1. The JSON schema:
  - [https://mmif.clams.ai/0.3.1/schema/mmif.json](schema/mmif.json)
1. The Vocabularies (the type hierarchies):
  - [https://mmif.clams.ai/0.3.1/vocabulary](vocabulary)
...
```json
{
  ...
  "contains": {
    "http://mmif.clams.ai/0.3.1/vocabulary/TimeFrame": {
      "unit": "seconds",
      "document": "m1" 
    } 
  },
...
```json
{
  "@type": "http://mmif.clams.ai/0.3.1/vocabulary/TimeFrame",
  "properties": {
    "id": "f1",
    "start": 0,
    "end": 5,
...
```json
{
  ...
  "metadata": {
    ...
    "timestamp": "2020-05-27T12:23:45",
    "contains": {
      "http://mmif.clams.ai/0.3.1/vocabulary/BoundingBox": {
        "document": "image3",
        "unit": "pixels" } }
  },
  "annotations": [
      { "@type": "http://mmif.clams.ai/0.3.1/vocabulary/BoundingBox",
        "properties": {
          "id": "bb0",
...
```json
{
  "documents": [
    {
      "@type": "http://mmif.clams.ai/0.3.1/vocabulary/ImageDocument",
      "properties": {
        "id": "m1",
        "mime": "image/jpeg",
  ...
  "views": [
    {
      ...
      "metadata": {
        ...
        "contains": {
          "http://mmif.clams.ai/0.3.1/BoundingBox": {
            "document": "m1" } }
      },
      "annotations": [
        { 
...
```json
{
  ...
  "metadata": {
    ...
    "contains": {
      "http://mmif.clams.ai/0.3.1/TextDocument": {},
      "http://mmif.clams.ai/0.3.1/Alignment": {} }
  },
  "annotations": [
    { 
      "@type": "http://mmif.clams.ai/0.3.1/vocabulary/TextDocument",
    ...
    {
      "@type": "http://mmif.clams.ai/0.3.1/vocabulary/Alignment",
      "properties": {
        "source": "v1:bb1",
        "target": "td1" }
    }
...
```json
{
  "id": "v2",
  "metadata": {
    "app": "http://mmif.clams.ai/apps/tesseract/0.3.1",
    "contains": {
      "http://mmif.clams.ai/0.3.1/vocabulary/TextDocument": {},
      "http://mmif.clams.ai/0.3.1/vocabulary/Alignment": {} }
  },
  "annotations": [
    { 
      "@type": "http://mmif.clams.ai/0.3.1/vocabulary/TextDocument",
...
```json
{
  ...
  "metadata": {
    "app": "http://mmif.clams.ai/apps/semantic-typer/0.2.4",
    "contains": {
      "http://mmif.clams.ai/0.3.1/vocabulary/SemanticTag": {} }
  },
  "annotations": [
    { 
      "@type": "http://mmif.clams.ai/0.3.1/vocabulary/SemanticTag",
      "properties": {
        "id": "st1",
        "category": "dog-sound",
        "document": "V2:td1",
...
The value of *@type* refers to the URL [http://mmif.clams.ai/0.3.1/vocabulary/BoundingBox](http://mmif.clams.ai/0.3.1/vocabulary/BoundingBox) which is a page in the published vocabulary. That page will spell out the definition of *BoundingBox* as well as list all properties defined for it, whether inherited or not. On the page we can see that *id* is a required property inherited from *Annotation* and that *coordinates* is a required property of *BoundingBox*. Both are expressed in the properties dictionary above. The page also says that there is an optional property *timePoint*, but it is not used above.
